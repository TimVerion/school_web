...
<body>
<center>
<form action="/stuManager/UpdateTeaServlet" enctype="multipart/form-data" method="post" id="form">
<table  width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" colspan="2" style="font-size:32px">个人信息</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input id="url1" type="text" class="input w50" value="${user.utype }" name="utype"  /></td>
  </tr>
  <tr>
