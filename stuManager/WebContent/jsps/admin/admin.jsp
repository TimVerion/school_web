...
<body>
<center>
<form action="/stuManager/UpdateAdminServlet" enctype="multipart/form-data" method="post" id="form">
<table  width="90%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="100px"> <img alt="" src="<c:url value='/${user.img }'/>" width="100" height="100" id="previewIm">
  ...
  <tr>
    ...
    <td><input id="url1" type="text" class="input w50" value="${user.pwd }" name="pwd"  /></td>
  </tr>
  <tr>
