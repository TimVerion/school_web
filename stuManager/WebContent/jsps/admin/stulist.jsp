...
function del(id){
		$.post("AdminServlet?method=del",{"ids":id},function(flag){
			if(flag){
				alert("删除成功");
				location="AdminServlet?method=findAll";
			}else{
				alert("删除失败");
			}
...
function toUpdate(id){
	location="AdminServlet?method=findStu&id="+id;
}
function add(){
	location="jsps/admin/addstu.jsp";
}
</script>
<body>
...
<table>
	<tr>
		...
		<td colspan="5">
				...
				<input type="hidden" name="method" value="mohu">
